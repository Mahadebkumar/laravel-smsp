...
@section('content')
    ...
    <table class="table table-stripped">
        <tr class="{{ $errors->has('tid') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::number('tid', $info->tid, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type teacher id'))}}
                @if($errors->has('tid'))
        ...
        <tr class="{{ $errors->has('tname') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::text('tname', $info->tname, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type teacher name'))}}
                @if($errors->has('tname'))
        ...
        <tr class="{{ $errors->has('tnid') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::number('tnid', $info->tnid, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type teacher  nid'))}}
                @if($errors->has('tnid'))
                    <span class="help-block" style="color:red; display:block">
        ...
        <tr class="{{ $errors->has('dob') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::date('dob', $info->dob, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type date of birth'))}}
                @if($errors->has('dob'))
                    <span class="help-block" style="color:red; display:block">
        ...
        <tr class="{{ $errors->has('email') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::email('email', $info->email, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type your email'))}}
                @if($errors->has('email'))
                    <span class="help-block" style="color:red; display:block">
        ...
        <tr class="{{ $errors->has('address') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::textarea('address', $info->address,['size' => '32x5'], array('class'=>'col-md-6 form-control', 'placeholder'=>' Type your address*'))}}
