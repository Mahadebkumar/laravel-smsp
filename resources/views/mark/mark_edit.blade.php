...
@section('content')
    ...
    <table class="table table-stripped">
        <tr class="{{ $errors->has('subid') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::number('subid', $info->subid, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type your subject id'))}}
                @if($errors->has('subid'))
        ...
        <tr class="{{ $errors->has('mark') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::number('mark', $info->mark, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type mark'))}}
                @if($errors->has('mark'))
                    <span class="help-block" style="display:block">
        ...
        <tr class="{{ $errors->has('sid') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::number('sid', $info->sid, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type your student id '))}}
                @if($errors->has('sid'))
                    <span class="help-block" style="display:block">
        ...
        <tr class="{{ $errors->has('examid') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::number('examid', $info->examid, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type your exam id '))}}
        ...
        <tr class="{{ $errors->has('year') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::number('year', $info->year, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type year '))}}
                @if($errors->has('year'))
                    <span class="help-block" style="display:block">
