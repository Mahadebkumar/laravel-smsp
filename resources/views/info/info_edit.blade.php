...
@section('content')
    ...
    {!! Form::open(array('route'=>['info.update', $info->id], 'method'=>'PUT', 'class'=>'form-horizontal', 'files'=>'true')) !!}
    ...
    <table class="table table-stripped">
        <tr class="{{ $errors->has('sname') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::text('sname', $info->sname, array('class'=>'col-md-6 form-control'))}}
                @if($errors->has('sname'))
        ...
        <tr class="{{ $errors->has('sbname') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::text('sbname', $info->sbname, array('class'=>'col-md-6 form-control', 'placeholder'=>''))}}
        ...
        <tr class="{{ $errors->has('roll') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::text('roll', $info->roll, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type your roll'))}}
                @if($errors->has('roll'))
                    <span class="help-block" style="display:block">
        ...
        <tr class="{{ $errors->has('reg') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::text('reg', $info->reg, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type your reg'))}}
                @if($errors->has('reg'))
                    <span class="help-block" style="display:block">
        ...
        <tr class="{{ $errors->has('section') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::select('section', ['null'=>'Select section*', 'A'=>'A', 'B'=>'B'], $info->section, array('class'=>'col-md-6 form-control'))}}
        ...
        <tr class="{{ $errors->has('session') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::text('session', $info->session, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type your session'))}}
        ...
        <tr class="{{ $errors->has('fname') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::text('fname', $info->fname, array('class'=>'col-md-6 form-control', 'placeholder'=>"Type your father's name"))}}
                @if($errors->has('fname'))
                    <span class="help-block" style="display:block">
        ...
        <tr class="{{ $errors->has('mname') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::text('mname', $info->mname, array('class'=>'col-md-6 form-control', 'placeholder'=>"Type your mother's name"))}}
                @if($errors->has('mname'))
                    <span class="help-block" style="display:block">
        ...
        <tr class="{{ $errors->has('gnid') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::text('gnid', $info->gnid, array('class'=>'col-md-6 form-control', 'placeholder'=>'Your father/mother NID number'))}}
                @if($errors->has('gnid'))
                    <span class="help-block" style="display:block">
        ...
        <tr class="{{ $errors->has('gender') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::radio('gender', 'male', false, ['id' => 'male']) }}Male
                ...
                {{--@if ($gender->gender == 'male')--}}
                    {{--{{ Form::radio('gender', 'male', true, ['checked' => 'checked']) }} Male--}}

                    {{--{{ Form::radio('gender', 'female', false, []) }} Female--}}
                {{--@else--}}
                    {{--{{ Form::radio('gender', 'male', false, []) }} Male--}}

                    {{--{{ Form::radio('gender', 'female', true, ['checked' => 'checked']) }} Female--}}
                {{--@endif--}}
        ...
        <tr class="{{ $errors->has('dob') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::date('dob', $info->dob, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type your date of birth'))}}
                @if($errors->has('dob'))
                    <span class="help-block" style="display:block">
        ...
        <tr class="{{ $errors->has('blood') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::select('blood', ['null'=>'Select blood group*','A+'=>'A+','A-'=>'A-','B+'=>'B+','B-'=>'B-','AB+'=>'AB+','AB-'=>'AB-','O+'=>'O+','O-'=>'O-' ], $info->blood, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type your blood group'))}}
                @if($errors->has('blood'))
                    <span class="help-block" style="display:block">
        ...
        <tr class="{{ $errors->has('religion') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::text('religion', $info->religion, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type your religion'))}}
        ...
        <tr class="{{ $errors->has('phone') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::number('phone', $info->phone, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type your phone number', 'id'=>'phone'))}}
                @if($errors->has('phone'))
                    <span class="help-block" style="display:block">
        ...
        <tr class="{{ $errors->has('gname') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::text('gname', $info->gname, array('class'=>'col-md-6 form-control', 'placeholder'=>'Type your guardian name'))}}
                @if($errors->has('gname'))
                    <span class="help-block" style="display:block">
        ...
        <tr class="{{ $errors->has('address') ? 'has-error' : '' }}">
            ...
            <td>{{ Form::textarea('address', $info->address, array('class'=>'col-md-6 form-control', 'placeholder'=>' Type your address*'))}}
